                    ...
                    <div class="col-lg-6">
                        <div class="card2 card border-0 px-4 py-5">
                            <div class="row mb-4 px-3">
                                <h6 class="mb-0 mr-8 mt-6">Sign Up</h6>
                                
                            </div>
                            <div class="row px-3">
                                <label class="mb-1"><h6 class="mb-0 text-sm">Username</h6></label>
                                <input class="mb-4" type="text" name="name" placeholder="Enter an username" required autofocus autocomplete="name">
                            </div>
                            ...
                            <div class="row px-3">
                                ...
                                <input type="password" name="password_confirmation" placeholder="Enter a confirm password" required autocomplete="new-password">
                            </div>
                            ...
                            <div class="row mb-4 px-3">
                                <small class="font-weight-bold">Already Register ? <a class="text-danger" href="{{ route('login') }}">Login</a></small>
                            </div>
                        </div>
                    </div>
                </div>
