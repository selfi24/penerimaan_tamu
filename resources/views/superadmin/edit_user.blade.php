                            ...
                            <fieldset>
                                ...
                                <div class="pl-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="username">Name<span class="small text-danger">*</span></label>
                                                <input type="text" id="username" class="form-control" name="username" placeholder="Name" value="{{ old('username', $user->username) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="email">Email<span class="small text-danger">*</span></label>
                                                <input type="email" id="email" class="form-control" name="email" placeholder="example@example.com" value="{{ old('email', $user->email) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="alamat">Alamat<span class="small text-danger">*</span></label>
                                                <input type="text" id="alamat" class="form-control" name="alamat" placeholder="Jl. Indonesia Raya" value="{{ old('alamat', $user->alamat) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="whatsapp">WhatsApp<span class="small text-danger">*</span></label>
                                                <input type="text" id="whatsapp" class="form-control" name="whatsapp" placeholder="086745454564" value="{{ old('whatsapp', $user->whatsapp) }}" pattern="\d+" title="Please enter a valid WhatsApp number. Only digits are allowed." required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                    <div class="form-group">
    <label class="form-control-label" for="opd">Asal Dinas</label>
    <select id="opd" name="opd" class="form-control">
        <option value="" disabled>Select Dinas</option>
        @foreach($opd as $item)
            <option value="{{ $item->id }}" {{ old('opd', $user->opd_id) == $item->id ? 'selected' : '' }}>
                {{ $item->dinas }}
            </option>
        @endforeach
    </select>
