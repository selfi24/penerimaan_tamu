...
<body>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('add_pengguna') }}" class="btn btn-primary">
    ...
    <form action="{{ route('user.dell', $user->id) }}" method="POST" style="display:inline;">
        @csrf
        @method('DELETE')
...
function editUser(user) {
    ...
    document.getElementById('modalOpd').value = user.opd_id;
    document.getElementById('modalWhatsapp').value = user.whatsapp;
        document.getElementById('modalWhatsapp').addEventListener('input', function (e) {
